...
const messages = {
  ENOFILES: `Verify: ❌ No files detected for upload. Did you run bundling first (if needed)? Is the "files" field of eik.json correct?`,
  EVERIFYFAIL: "Verify: ❌ Verification checks failed to complete",
  FOUNDFILES: "Verify: ✅ Found %d file(s) to publish",
};
