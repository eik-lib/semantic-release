...
const messages = {
  PUBLISHSUCCESS: (name, version, url) =>
    `Successfully published package ${name} (v${version}) to ${url}.`,
  PUBLISHFAILURE: (name, version, url) =>
    `Unable to locate package ${name} (v${version}) at ${url}. It appears something went wrong during publish.`,
};
